...
namespace Maptz.QuickVideoPlayer
{
    ...
    public partial class App : Application
    {
        ...
        public const string FFMPEGPath = @"X:\+++DEV\MaptzGitHub\wpf\maptz.wpf.videoplayer\src\Maptz.Wpf.VideoPlayer\ffmpeg-4.1.1-win64-shared\ffmpeg-4.1.1-win64-shared\bin\ffmpeg.exe";


        public IServiceProvider ServiceProvider { get; private set; }
        public IAppCommandEngine CommandEngine { get; private set; }
        public ISessionStateService SessionStateService { get; private set; }
